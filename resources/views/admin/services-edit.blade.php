        ...
        @csrf
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                        <span class="required">Intro</span>
                    </label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="intro" class="form-control form-control-lg form-control-solid" value="{{$data->intro}}" required/>
                    </div>
                    <!--end::Col-->
                </div>
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <a href="{{ Request::segment(1) }}/services" class="btn btn-light btn-active-light-primary me-2">Back</a>
