...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <!--begin::Form-->
        <form class="form" action="{{url('admin/options/'.$data->id.'/edit')}}" method="POST" enctype="multipart/form-data">
        @csrf
            <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                        <span class="required">{{ucfirst($data->name)}} ({{$data->description}})</span>
                    </label>
                    <!--end::Label-->
                    <!--begin::Col-->
